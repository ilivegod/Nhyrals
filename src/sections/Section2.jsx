...
const Section2 = () => {
  return (
    <section id="section2" className="max-container ">
      <div className="border-2 border-gray-100 shadow-lg flex flex-col justify-center items-center gap-5 xl:py-11 xl:px-4 py-5 px-6">
        ...
        <div className="xl:mt-3 mt-6">
          <p className="text-gray-600 font-montserrat  text-center text-wrap leading-7 text-xs">
